...
[image4]: ./german_signs/caution.jpg "Caution Sign 1"
...
Here is an exploratory visualization of the data set. It is a bar chart showing how many example images per class.

![alt text][image1]

Here are some sample images, 5 per class, 43 classes.
...
As a first step, I decided to convert the images to grayscale because this speeds training and in most cases is enough to distinguish sign types.
...
LeNet was the suggested architecture, and seemed to fit the problem quite well. It needs the depth to represent the number of features to generalize 43 classes, while not enough weights to make memorization of training set the best choice for learning.
...
The model was able to correctly guess 5 of the 5 traffic signs, which gives an accuracy of 100%. Originally, the test images were cropped too closely and resulted in reduced accuracy of 57%. Once cropping changed to more closely match the test set, the network performed flawlessly on the small sample set.
